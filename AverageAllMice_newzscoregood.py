...
cs = ax1.imshow(new_array_reshape_rearrange_row_means, cmap=plt.cm.plasma, interpolation='none', aspect="auto", vmin = -0.36758642684375425 -0.5, vmax = 6.463251109197573 + 0.5,
